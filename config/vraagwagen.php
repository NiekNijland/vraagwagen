...
return [
    'llm_model' => env('VRAAGWAGEN_LLM_MODEL', 'gpt-4.1-mini'),
    ...
    'prompt' => [
        ...
        'max_length' => (int) env('VRAAGWAGEN_MAX_PROMPT_LENGTH', 2000),
        'min_length' => 3,
    ],
    'rate_limit' => [
        'per_minute' => env('VRAAGWAGEN_RATE_LIMIT_PER_MINUTE', 10),
        'per_day_ip' => env('VRAAGWAGEN_RATE_LIMIT_PER_DAY_IP', 25),
        'per_day_global' => env('VRAAGWAGEN_RATE_LIMIT_PER_DAY_GLOBAL', 50),
        'feedback_per_minute' => env('VRAAGWAGEN_RATE_LIMIT_FEEDBACK_PER_MINUTE', 30),
    ],
